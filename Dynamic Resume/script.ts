document.addEventListener("DOMContentLoaded", () => {
  ...
  form.addEventListener("submit", (event) => {
    ...
    const FormSkills = (document.getElementById("FormSkills") as HTMLInputElement).value;
    const summary = (document.getElementById("summaryInput") as HTMLInputElement).value;
